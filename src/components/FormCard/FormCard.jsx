...
const FormCard = () => {
  ...
  return (
    <>
      {!isCallAccepted && (
        <div className="form-section w-full backdrop-blur-md bg-background-light/75 dark:bg-background-dark/75 text-text-light dark:text-text-dark p-4 z-50 shadow-sm">
          <Card className="card">
            <Form noValidate autoComplete="off">
              ...
              <CopyToClipboard text={myUserId}>
                <Button
                  className="form-main-btn mb-3 flex flex-row gap-4"
              ...
              <Button
                className="form-main-btn flex flex-row gap-4"
