  ...
  return (
    <div className=" text-white min-h-screen p-6 ">
      ...
      {initial && (
        <section
			id="waitlist"
			className="relative bg-page-gradient [box-shadow:0_-20px_80px_-20px_#8686f01f_inset] min-h-[600px] border-[1px] border-white/20 flex flex-col gap-8 justify-center items-center mt-8 mb-28 w-full md:w-3/4 rounded-3xl py-1 px-3 md:px-8 mx-auto"
		>
